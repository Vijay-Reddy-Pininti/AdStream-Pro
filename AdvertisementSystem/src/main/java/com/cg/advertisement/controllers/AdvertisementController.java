package com.cg.advertisement.controllers;
...
import com.cg.advertisement.services.AdvertisementService;
...
public class AdvertisementController {
	...
	public Advertisement getAdvertisementById(@PathVariable long advertisementId) {
		/*
	 	...
	 	Action: Gets advertisement details from the back-end database based on the advertisementId
	...
	public String updateAdvertisement(@PathVariable long advertisementId, @RequestBody Advertisement advertisement) {
		/*
	 	...
	 	Last Modified on : 05-04-2020
	 */
		Advertisement add1 = new Advertisement(advertisementId,advertisement.getAdvtDescription(),advertisement.getAdvtCategory(),advertisement.getItemAge());
