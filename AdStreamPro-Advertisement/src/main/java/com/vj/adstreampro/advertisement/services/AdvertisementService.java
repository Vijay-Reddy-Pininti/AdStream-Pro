package com.vj.adstreampro.advertisement.services;
...
import com.vj.adstreampro.advertisement.repositories.AdvertisementRepository;
...
public class AdvertisementService {
	...
	public Advertisement getAdvertisementById(long advertisementId) {
		 ...
		 * Action: Gets user details from the back-end database based on the
		 * advertisementId
