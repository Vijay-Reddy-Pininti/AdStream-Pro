package com.cg.advertisement.userservice.controllers;
...
import com.cg.advertisement.userservice.services.UserService;
...
public class UserController {
	...
	public String updateUser(@PathVariable long userId, @RequestBody User user) {
		/*
	 	...
	 	Last Modified on : 05-04-2020
	 */
		User user1 = new User(userId,user.getFirstName(),user.getLastName(),user.getEmail(),user.getPassword(),user.getGender(),user.getContact(),user.getLocation(),user.getUserRole());
