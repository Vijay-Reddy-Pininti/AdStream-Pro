package com.cg.advertisement.reviewService.services;
...
import com.cg.advertisement.reviewService.entities.Review;
import com.cg.advertisement.reviewService.repositories.ReviewRepository;
...
public class ReviewService {
	...
	public String deleteReviewById(long reviewId) {
		/*
	 	...
	 	Action: Gets review details from the back-end database based on the reviewId and deletes it
	...
	public String updateReviewById(long reviewId, Review review) {
		/*
	 	Author: Pininti Vijay Reddy
	 	Input: takes the reviewId
	 	Action: Gets review details from the back-end database based on the reviewId and updates it
